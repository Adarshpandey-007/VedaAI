        ...
        <div className={styles.overlay}>
          <div className={styles.hudCard}>
            ...
            <div className={styles.hudLoader}>
              <span className={styles.hudPercent}>{generationProgress}%</span>
              <div className={styles.hudProgressContainer}>
                <div 
                  className={styles.hudProgressBar} 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <span className={styles.hudStatus}>{generationStatusText}</span>
              <span className={styles.hudSubText}>Queue is processing. Our worker is compiling CBSE sections.</span>
            </div>
          </div>
        </div>
      )}
